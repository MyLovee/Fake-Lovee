...
echo $cyan" |*|  $yellow        Web      : www.sharkxploit.tk                 $cyan  |*|"
echo $cyan" |*|  $yellow        blog     : www.blog-sharkxploit.tk            $cyan  |*|"
...
echo $cyan "[+]============================================================[+]"
echo $cyan "[+]$yellow 31.Install Fake-Face                                     $cyan  [+]"
echo $cyan "[+]============================================================[+]"
echo $cyan "[+]$yellow 32.Install T-Xploiter                                    $cyan  [+]"
echo $cyan "[+]============================================================[+]"
echo $cyan "[+]$yellow 33.Install                                               $cyan  [+]"
echo $cyan "[+]============================================================[+]"
...
pkg install curl
pkg install git
git clone https://github.com/MyLovee/Fake-Face
cd Fake-Face
sh Face.sh
fi

if [ $kampang = "32" ] || [ $kampang = "32" ]
then
echo $cyan
clear
figlet "Menginstal"
...
echo""
echo $yellow "----------------------------------------"
echo $yellow "| Author : '/Mine7            $yellow          | "
echo $yellow "| Github : https://github.com/MyLovee $yellow  |"
echo $yellow "| My Team : SharkXploit                 |"
echo $yellow "| Instagram : labib_wso                 |"
echo $cyan   "| Whatsapp : 0895378276565              |"
echo $cyan   "| Muehehehehe                           |"
echo $cyan   "| Name Tolls : Fake-Lovee     $cyan          |"
echo $cyan   "| Versi : 2                   $cyam          |"
echo $cyan "---------------------------------------"
echo $yellow   "–=My Friends=–"
echo $cyan "Mine7"
echo $yellow   "Palkon"
echo $cyan "Botak Nol3p"
echo $yellow   "IY×KID"
echo $cyan "Xlon3ly"
echo $yellow   "IY×Labil"
echo $cyan "Wahyu Dhimas/Ogeb"
echo $yellow   "Tuan Ryu"
echo $cyan "InYourGrzly"
echo $green
echo "╭─[B]:Back [E]:Exit "
echo "|"$yellow
read -p "╰─[B]/[E] :" kontol
