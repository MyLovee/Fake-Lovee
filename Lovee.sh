...
echo $cyan" |*|  $yellow        Team     : 2Easy4Hack Team and SharkXploit      $cyan  |*|"
...
sleep 1
echo $cyan "Thanks To : 2Easy4Hsck Team - ShsrkXploit - Ancient One "
sleep 1
echo $cyan "and all pemogramer indonesia"
sleep 1
echo $cyan "special Thanks to : InYourHeart - Xlon3ly - InYourNick - InYourZamaludin404 - IY脳KID And all my friends"
sleep 1
